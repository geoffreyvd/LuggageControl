...
public class SecurityMan {
     ...
     * @param secUpdatesReference instance of abstract securityUpdates class to push events
     */
    ...
    /**
     * Gets the timeout time and returns it
     * Please note that the timer is not guaranteed to run at this interval
    ...
    /**
     * Sets the timeout time to the new specified time
     * Please note that the timer time does not change until you reset the timer.
    ...
    /**
     * Resets the timeout time to the default time
     * Please note that the timer time does not change until you reset the timer.
     * @return true if succeeded, false when failed.
     */
